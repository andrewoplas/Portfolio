...
export const Footer = () => (
  <footer
    id="contact"
    className="relative flex flex-col items-center bg-primary pb-20 pt-20 md:min-h-[800px] md:pt-24 lg:min-h-[1000px] lg:pt-28"
  >
    ...
    <div className="relative w-full md:-mt-[120px]">
      <div
      ...
      <Image
        ...
        height={579}
        alt=""
        className="h-full min-h-[400px] w-full object-cover lg:min-h-[unset] "
      />
    </div>

    <div className="z-[1] flex w-full max-w-section flex-col items-center gap-8 px-4 text-background md:flex-row md:justify-between md:px-8">
