    ...
    <div className="mt-12 grid gap-6 md:mt-16 md:grid-cols-3">
      {testimonials.map((testimonial) => (
        <div
          ...
          className="relative flex flex-col rounded-card bg-white p-8 text-center transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-neutral-200 md:p-10"
        >
          <Link
            target="_blank"
